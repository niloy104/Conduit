...
type OrderRes struct {
	...
	UpdatedAt     *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"` //   OrderStatus               status         = 10;
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_proto_rawDesc = "" +
	...
	"is_revoked\x18\x04 \x01(\bR\tisRevoked\x129\n" +
	"\n" +
	"expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt2\x88\a\n" +
	"\x05ecomm\x121\n" +
	...
	"\rDeleteSession\x12\x0e.pb.SessionReq\x1a\x0e.pb.SessionRes\"\x00B%Z#github.com/niloy104/Conduit/grpc/pbb\x06proto3"
...
var file_api_proto_depIdxs = []int32{
	...
	4,  // 20: pb.ecomm.UpdateOrderStatus:input_type -> pb.OrderReq
	4,  // 21: pb.ecomm.DeleteOrder:input_type -> pb.OrderReq
	7,  // 22: pb.ecomm.CreateUser:input_type -> pb.UserReq
	7,  // 23: pb.ecomm.GetUser:input_type -> pb.UserReq
	7,  // 24: pb.ecomm.ListUsers:input_type -> pb.UserReq
	7,  // 25: pb.ecomm.UpdateUser:input_type -> pb.UserReq
	7,  // 26: pb.ecomm.DeleteUser:input_type -> pb.UserReq
	10, // 27: pb.ecomm.CreateSession:input_type -> pb.SessionReq
	10, // 28: pb.ecomm.GetSession:input_type -> pb.SessionReq
	10, // 29: pb.ecomm.RevokeSession:input_type -> pb.SessionReq
	10, // 30: pb.ecomm.DeleteSession:input_type -> pb.SessionReq
	1,  // 31: pb.ecomm.CreateProduct:output_type -> pb.ProductRes
	1,  // 32: pb.ecomm.GetProduct:output_type -> pb.ProductRes
	2,  // 33: pb.ecomm.ListProducts:output_type -> pb.ListProductRes
	1,  // 34: pb.ecomm.UpdateProduct:output_type -> pb.ProductRes
	1,  // 35: pb.ecomm.DeleteProduct:output_type -> pb.ProductRes
	5,  // 36: pb.ecomm.CreateOrder:output_type -> pb.OrderRes
	5,  // 37: pb.ecomm.GetOrder:output_type -> pb.OrderRes
	6,  // 38: pb.ecomm.ListOrders:output_type -> pb.ListOrderRes
	5,  // 39: pb.ecomm.UpdateOrderStatus:output_type -> pb.OrderRes
	5,  // 40: pb.ecomm.DeleteOrder:output_type -> pb.OrderRes
	8,  // 41: pb.ecomm.CreateUser:output_type -> pb.UserRes
	8,  // 42: pb.ecomm.GetUser:output_type -> pb.UserRes
	9,  // 43: pb.ecomm.ListUsers:output_type -> pb.ListUserRes
	8,  // 44: pb.ecomm.UpdateUser:output_type -> pb.UserRes
	8,  // 45: pb.ecomm.DeleteUser:output_type -> pb.UserRes
	11, // 46: pb.ecomm.CreateSession:output_type -> pb.SessionRes
	11, // 47: pb.ecomm.GetSession:output_type -> pb.SessionRes
	11, // 48: pb.ecomm.RevokeSession:output_type -> pb.SessionRes
	11, // 49: pb.ecomm.DeleteSession:output_type -> pb.SessionRes
